...
# Requires Circom 2.x with support for pragma circom 2.1.9. This mirrors the
# existing Stage 3 scripts and uses WSL when the thesis environment has the
# Rust Circom binary installed there.
...
wsl bash -c "cd '/mnt/c/Paper/Masters thesis/stage3_zk/circuits/exact_shap_top3' && circom exact_shap_top3.circom -o build --r1cs --wasm --sym -l ../../node_modules"
