...
wsl bash -c "cd '/mnt/c/Paper/Masters thesis/stage3_zk/circuits/semantic_groups' && /usr/local/bin/circom semantic_groups.circom -o build --r1cs --wasm --sym -l ../../node_modules"
if ($LASTEXITCODE -ne 0) {
